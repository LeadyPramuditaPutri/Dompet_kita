...
public class ChartView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getExtras() == null){
            ...
            Log.d("cek:",String.valueOf(i.getFloatExtra("Pemasukkan",0)));
        }
        float come = i.getFloatExtra("Pemasukkan",0);
        float out = i.getFloatExtra("Pengeluaran",0);
        setData(come,out);
    ...
    private void setData(float Pemasukkan, float Pengeluaran) {
        ...
        // the chart.
        entries.add(new PieEntry((float) Pemasukkan, "Pemasukkan"));
        entries.add(new PieEntry((float) Pengeluaran, "Pengeluaran"));


        PieDataSet dataSet = new PieDataSet(entries, "DompetKita Graphics per-Week");
